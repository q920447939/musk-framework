 ...
 */
package org.example.musk.middleware.mybatisplus.anno;

import org.example.musk.middleware.mybatisplus.mybatis.MuskMapperScannerRegistrar;
...
@Documented
@Import(MuskMapperScannerRegistrar.class)
public @interface MuskMapperScan {
