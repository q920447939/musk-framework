package org.example.musk.middleware.mybatisplus.mybatis.core.handler;
        ...
        if (Objects.nonNull(metaObject) && metaObject.getOriginalObject() instanceof BaseDO) {
            ...
            if (null != memberId) {
                ...
                if (Objects.isNull(baseDO.getCreator())) {
                    baseDO.setCreator(memberId.toString());
                }
                // 当前登录用户不为空，更新人为空，则当前登录用户为更新人
                if (Objects.isNull(baseDO.getUpdater())) {
                    baseDO.setUpdater(memberId.toString());
                }
            }
    ...
    public void updateFill(MetaObject metaObject) {
        ...
        if (null != memberId) {
            if (Objects.isNull(modifier)) {
                setFieldValByName("updater", memberId.toString(), metaObject);
            }
        }
