...
import org.example.musk.functions.system.params.controller.appParamsConfig.vo.AppParamsConfigUpdateReqVO;
...
@Validated
@Slf4j
public class AppParamsConfigControllerWithPermission {
    ...
    public CommonResult<String> queryAppParamsConfigByTypeValue1(@RequestParam("type") String type) {
        ...
        return CommonResult.success(appParamsConfigService.queryAppParamsConfigByTypeValue1(
     ...
     */
    @PutMapping("/update")
    public CommonResult<Boolean> updateAppParamsConfig(@RequestBody @Valid AppParamsConfigUpdateReqVO reqVO) {
        // 检查是否有权限更新此配置项
