...
public interface MemberLevelBenefitService {
     ...
     * @return 权益ID
     */
    Integer createLevelBenefit(Integer tenantId,Integer domainId,MemberLevelBenefitCreateReqVO createReqVO);
     ...
     */
    void updateLevelBenefit(Integer tenantId,Integer domainId,MemberLevelBenefitUpdateReqVO updateReqVO);
     ...
     * @param id 权益ID
     */
    void deleteLevelBenefit(Integer domainId,Integer id);
     ...
     * @return 权益列表
     */
    List<MemberLevelBenefitVO> getMemberCurrentBenefits(Integer domainId,Integer memberId);
     ...
     * @return 是否拥有
     */
    boolean hasBenefit(Integer domainId,Integer memberId, Integer benefitType);
     ...
     * @return 权益值
     */
    String getBenefitValue(Integer domainId,Integer memberId, Integer benefitType);
}
